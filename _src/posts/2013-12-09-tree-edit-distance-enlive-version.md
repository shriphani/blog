    Title: Tree Edit Distance Enlive Version
    Date: 2013-12-09T03:52:34
    Tags: tree-edit-distance, research, enlive

In my last post, I presented a code-dump that computed a restricted
version of the tree edit distance algorithm. I was able to achieve a
decent speed-up using enlive. Here's a code-dump:
...
This is now a convenient implementation that you can use. The full
source code is in this
[GitHub repo](https://github.com/shriphani/tree-edit-distance).
